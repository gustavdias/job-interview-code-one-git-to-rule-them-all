...
var Person = function(firstName, lastName, dateOfBirth, measurements){
    ...
    personClone = JSON.parse(JSON.stringify(person));//it became JSON and then a Object again, so is the same as just person
    ...
    //3. person === personClone //!false because they are different objects that happens to be with the same content.
    // person == personClone //!false too
    ...
    console.log(person);//Person {firstName: "Jim", lastName: "Perice", dateOfBirth: Tue Mar 12 2013 00:00:00 GMT+0400 (Moscow Standard Time), measurements: {…}}
    console.log(personJson);//{"firstName":"Jim","lastName":"Perice","dateOfBirth":"2013-03-11T20:00:00.000Z","measurements":{"weight":"70kg"}}
    ...
    var b = a
    var c = a.slice() // "a.slice()" is not the same as "a"
    // when you push date to a, it isn't the same a that was sliced and assigned to c.
    var d = b;
    a.push("date")

    console.log("this is a:"+a, "/ this is b: "+b,"/ this is c: "+ c, "/ this is d: "+ d)
